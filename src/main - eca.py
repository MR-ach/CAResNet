...
class CNN(keras.Model):
    ...
    def train(self, train_db, test_db, epochs):
        ...
        # np.savetxt ('./results/cnn_eca/eca_710.txt',af)
        # np.savetxt('./results/cnn_eca/eca_loss_710.txt', los)
        np.savetxt('./results/cnn_eca/pred.txt', pred)
        np.savetxt('./results/cnn_eca/label.txt', label)
        print(pred)
        return pred
...
cnn = CNN(input_shape)
cnn.train(train_db, test_db, epochs=55)