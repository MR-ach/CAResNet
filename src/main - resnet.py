...
class CNN(keras.Model):
    ...
    def train(self, train_db, test_db, epochs):
        ...
        # np.savetxt ('./results/cnn_resnet/resnet_650.txt',af)
        # np.savetxt('./results/cnn_resnet/resnet_loss_650.txt', los)
        np.savetxt('./results/cnn_resnet/pred.txt', pred)
        np.savetxt('./results/cnn_resnet/label.txt', label)
        print(label)
        print(pred)
...
cnn = CNN(input_shape)
cnn.train(train_db, test_db, epochs=46)
