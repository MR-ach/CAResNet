...
class CNN(keras.Model):
    ...
    def train(self, train_db, test_db, epochs):
        ...
        # tf.reduce_mean(af)
        # np.savetxt ('./results/cnn_resnet_se/res_se_30.txt',af)
        # np.savetxt('./results/cnn_resnet_se/res_se_loss_30.txt',los)
...
cnn = CNN(input_shape)
cnn.train(train_db, test_db, epochs=1)